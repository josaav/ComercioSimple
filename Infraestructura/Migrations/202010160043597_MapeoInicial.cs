                ...
                c => new
                    {
                        ...
                        NombreFantasia = c.String(maxLength: 250),
                        Cuit = c.String(nullable: false, maxLength: 13),
                        Telefono = c.String(maxLength: 25),
                        Celular = c.String(maxLength: 25),
                        Direccion = c.String(nullable: false, maxLength: 400),
                        ...
                        ObservacionEnPieFactura = c.String(maxLength: 400),
                ...
                c => new
                    {
                        ...
                        CodigoBarra = c.String(nullable: false, maxLength: 100),
                        Abreviatura = c.String(maxLength: 10),
                        Descripcion = c.String(nullable: false, maxLength: 250),
                        Detalle = c.String(maxLength: 500),
                ...
                c => new
                    {
                        ...
                        Observacion = c.String(nullable: false, maxLength: 400),
                        EstaEliminado = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Articulo", t => t.ArticuloId)
                ...
                c => new
                    {
                        ...
                        BancoId = c.Long(nullable: false),
                        Numero = c.String(nullable: false, maxLength: 100),
                        Titular = c.String(nullable: false, maxLength: 250),
                        EstaEliminado = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Banco", t => t.BancoId)
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        RazonSocial = c.String(nullable: false, maxLength: 250),
                        CUIT = c.String(nullable: false, maxLength: 15),
                        Direccion = c.String(nullable: false, maxLength: 400),
                        Telefono = c.String(maxLength: 25),
                        Mail = c.String(nullable: false, maxLength: 250),
                        LocalidadId = c.Long(nullable: false),
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        Descripcion = c.String(nullable: false, maxLength: 250),
                        Ubicacion = c.String(maxLength: 400),
                        EstaEliminado = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        NumeroTarjeta = c.String(nullable: false, maxLength: 100),
                        CuponPago = c.String(nullable: false, maxLength: 100),
